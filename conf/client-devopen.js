...
module.exports = function(options) {
  ...
  var defaultLayout = options.defaultLayout || "snlab.devopen.layout";
  ...
  var plugins = [
    ...
    },
    {
      ...
      staticPrefix: staticPrefix + "/plugins/" + defaultLayout,
    ...
    },
    {
      ...
      staticPrefix: options.staticPrefix + "/plugins/" + defaultLayout
    },
    ...
    // Layout & Panels
    {
      packagePath: "plugins/" + defaultLayout + "/layout",
      staticPrefix: staticPrefix + "/plugins/" + defaultLayout,
      dashboardUrl: options.dashboardUrl,
      cdn: options.useCdn
    },
    ...
    {
      packagePath: "plugins/" + defaultLayout + "/preload",
